...
TOKEN = '6738771472:AAEKLKUj6Wf8xy2C43oPR1KAdGBRxy5lo7M'
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACCESS:-@DKSTOREOP*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :-@DKSTOREOP*", parse_mode='Markdown')
